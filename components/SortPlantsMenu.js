...
const SortPlantsMenu = ({ onSortChange, className = "" }) => {
  ...
  return (
    <div ref={dropdownRef} className={`inline-flex ${className}`}>
      ...
      {isOpen && (
        <div className="absolute z-10 mt-10 bg-white/50 backdrop-blur-sm dark:bg-custom-dark-blue border border-gray-300 dark:border-custom-light-gray rounded-lg shadow-lg min-w-[180px] w-auto">
